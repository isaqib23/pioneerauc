...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Bidding Summary (Auction/Item Wise)<small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="auctionId" id="auctionId" class="form-control col-md-7 col-xs-12">
              <option selected value="all">All Auctions</option>
              <?php
              if($auctions){
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select  name="itemId" id="itemId" class="form-control col-md-7 col-xs-12">
              <option selected value="all">All Items</option>
            </select>
            <span class="valid-error text-danger itemId-error"></span>
          </div>
...
$("#filter").on("click", function(event){
  ...
  var dtReports = dtBuilder({
    ...
    'orderColumn': 0,
    'order': 'ASC',
    'url' : "<?= base_url('reports/bidding_summary_process'); ?>",
    'ajaxData' : filters,
    'filterFields': [],
    'dbFields': [
      {'data':'id'},
...
$("#auctionId").on("change", function(event){
  event.preventDefault();
  var auctionId = $(this).val();
  //console.log(auctionId);

  $.ajax({
    url: "<?= base_url('reports/items_against_auction'); ?>",
    type: 'POST',
    data: {
