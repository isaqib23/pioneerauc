...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Live Auction Wise Temporary Deposits <small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="auctionId" id="auction_list" class="form-control col-md-7 col-xs-12"></select>
        ...
        <table id="dt-reports" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th>Email</th>
              <th>Mobile</th>
              <th data-orderable="false">Temporary Deposit</th>
            </tr>
          </thead>
        </table>
      </div>
...
$(document).ready(function(){
  ...
  function get_auctions_between_dates(startDate, endDate){
    $.ajax({
      type: 'POST',
      url: "<?= base_url('reports/live_auctions_between_dates'); ?>",
...
$("#filter").on("click", function(event){
  ...
  if(validation == true){
    ...
    var dtReports = dtBuilder({
      ...
      'orderColumn': 0,
      'order': 'ASC',
      'url' : "<?= base_url('reports/live_auction_wise_deposits_process'); ?>",
      'ajaxData' : filters,
      'filterFields': [],
      'dbFields': [
        {'data':'id'},
