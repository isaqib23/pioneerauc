...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Cashier Report <small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="cashierId" class="form-control col-md-7 col-xs-12">
  ...
  function get_auctions_between_dates(startDate, endDate){
    $.ajax({
      ...
      success: function (result) {
        console.log(result);
        // $("#auctionId").html('');
        var allAuctions = '<option value = "all">All Auctions</option>'+result;
        $("#auction_list").html(allAuctions);
      }
    });
  }
...
$("#filter").on("click", function(event){
  ...
  var dtReports = dtBuilder({ 
    ...
    'orderColumn': 0,
    'order': 'ASC',
    'url' : "<?= base_url('reports/permanent_depost_refund_process'); ?>",
    'ajaxData' : filters,
    'filterFields': [],
    'dbFields': [
      {'data':'userCode'},
