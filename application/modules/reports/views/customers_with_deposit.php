...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Customers With Deposits <small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
            ...
            <div class="control-group">
              <div class="controls">
                <div class="input-prepend input-group">
                  ...
                  <input type="text" name="rangeDeposit" id="rangeDeposit" class="form-control" value="01/01/2016 - 01/25/2016" />
                </div>
              </div>
            </div>
          </div> -->
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="depositType" class="form-control col-md-7 col-xs-12">
              <option selected value="">Select Deposit Type</option>
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="minRange" class="form-control col-md-7 col-xs-12">
              <option value="">Select Minimum Deposit</option>
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="maxRange" class="form-control col-md-7 col-xs-12">
              <option value="">Select Maximum Deposit</option>
              <option value="5000">5,000</option>
              <option value="10000">10,000</option>
              <option value="25000">25,000</option>
              <option value="50000">50,000</option>
        ...
        <table id="dt-reports" class="table table-striped table-bordered">
          <thead>
            <tr>
              ...
              <th>Email</th>
              <th>Mobile</th>
              <th>Permanent Deposit</th>
              <th>Temporary Deposit</th>
            </tr>
          </thead>
        </table>
      </div>
...
$("#filter").on("click", function(event){
  ...
  var dtReports = dtBuilder({
    ...
    'orderColumn': 0,
    'order': 'ASC',
    'url' : "<?= base_url('reports/customers_with_deposit_processing'); ?>",
    'ajaxData' : filters,
    'filterFields': [],
    'dbFields': [
      {'data':'id'},
