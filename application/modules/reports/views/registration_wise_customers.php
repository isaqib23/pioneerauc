...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Registration Wise Customers <small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="reg_type" class="form-control col-md-7 col-xs-12">
...
$("#filter").on("click", function(event){
  ...
  var dtReports = dtBuilder({
    ...
    'orderColumn': 0,
    'order': 'ASC',
    'url' : "<?= base_url('reports/registration_wise_customers_process'); ?>",
    'ajaxData' : filters,
    'filterFields': [],
    'dbFields': [
      {'data':'id'},
