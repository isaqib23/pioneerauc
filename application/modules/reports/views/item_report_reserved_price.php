...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>Item Report (Reserved Price)<small></small></h2>
      ...
      <div class="x_content">
        ...
        <form method="post" id="rptfrm" action="">
          ...
          <div class="form-group col-md-3 col-sm-6 col-xs-6">
            <select name="reservedPrice" id="item_sold_status" class="form-control col-md-7 col-xs-12">
              <option selected value="all">All Prices</option>
              <option value="higher">Sold Higher Than Reserved Price</option>
              <option value="equal">Sold Equal To Reserved Price</option>
            </select>
          </div>
...
$("#filter").on("click", function(event){
  ...
  if (validation == true) {
    ...
    var dtReports = dtBuilder({
      ...
      'orderColumn': 0,
      'order': 'ASC',
      'url' : "<?= base_url('reports/item_report_reserved_price_process'); ?>",
      'ajaxData' : filters,
      'filterFields': [],
      'dbFields': [
        {'data':'seller'},
