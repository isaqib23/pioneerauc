        ...
        <?php } ?>
         <?php 
            ...
            <form method="post" novalidate="" id="demo-form2" name="ozform" action="" enctype="multipart/form-data" class="form-horizontal form-label-left">
                ...
                <!-- <div class="item form-group">    
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="policy_english_title">Privacy Policy Image
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="file"   id="image" name="image">
                        <?php //if(isset($row)){
                            //$file = $this->db->get_where('files', ['id' => $row['image']])->row_array(); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#send').on('click', function(event){
            ...
            // var content6 = tinymce.get("policy_arabic_description").getContent();
