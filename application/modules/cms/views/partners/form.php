            ...
            <form method="post" novalidate="" id="demo-form2" name="ozform" action="" enctype="multipart/form-data" class="form-horizontal form-label-left">
                ...
                <div class="item form-group">    
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="status" required="required" class="form-control col-md-7 col-xs-12">
                            <option <?php if(isset($edit) && ($edit['status'] == '1')) { echo "selected='selected'"; } ?> value="1">Active</option>
                            <option <?php if(isset($edit) && ($edit['status'] == '0')) { echo "selected='selected'"; } ?> value="0">In Active</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="item form-group">    
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php if(isset($edit)){
                            $file = $this->db->get_where('files', ['id' => $edit['image']])->row_array(); ?>
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo base_url().'cms/partners_listing/'; ?>" class="custom-class" type="button"> 
                        Cancel
                    </a>
                    </div>
                </div>
            ...
            $.ajax({
                ...
                var objData = jQuery.parseJSON(data);
                   if (objData.success == true) { 
                        window.location = base_url + 'cms/partners_listing';
                    } else {
