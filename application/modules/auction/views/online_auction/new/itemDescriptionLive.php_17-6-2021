        ...
        <div class="description-listing">
            ...
            <ul class="item-stats d-flex align-items-center">
                ...
                <li>
                    ...
                    <?= date('D, M d, Y' ,strtotime($auction_details['start_time'])) ?> - <?= date('h:i A' ,strtotime($auction_details['start_time'])); ?><!--GST--></li>
            </ul>
                            ...
                            <div class="slider-for">
                                ...
                                if ($images):
                                    foreach ($images as $key => $value): ?>
                                        <div class="img">
                                            <img onclick="livesliderRefresh()" data-toggle="modal" data-target="#liveModal" src="<?= base_url('uploads/items_documents/').$item['id'].'/'.$value['name']; ?>">
                                        </div>
                                    <?php endforeach;
                                else: ?>
                      ...
                      <div class="right-image-inner">
                        <p class="right-image-heading">
                            <?= $this->lang->line('bid_live_on_this_item'); ?> <br/> 
                             ...
                             <?php
                     $startTime = strtotime($auction_details['start_time']);
                     if($language == 'arabic'){
                         ...
                         ?>
                         <?= date('D, M d, Y' ,strtotime($auction_details['start_time'])) ?> - <?= date('h:i A' ,strtotime($auction_details['start_time'])); ?>
                    <?php }
                     ?>
