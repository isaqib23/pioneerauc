  ...
  <div class="x_panel">
    <!-- <form method="post" id="demo-form2" action="" enctype="multipart/form-data" class="form-horizontal form-label-left ">
       ...
       <!--  <input type="hidden" name="auction_id" value="<?php //echo $auction_id; ?>">
        <input type="hidden" name="auction_id" value="<?php //echo $category_id; ?>"> -->
  </div>
  <!-- <?php
  print_r($item_ids_list);
  ?> -->
   <div id="result_add_items"></div>

      <div class="x_panel search_block">
        <?php 
        ...
        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
          ...
          <input type="hidden" name="category_id" id="cat_id" value="<?php echo $category_id; ?>">
        </form>
      </div>   
      <div class="x_panel">
                ...
                foreach($items_list as $value){
                  // print_r($items_list);die();
                    ...
                    <tr id="row-<?php echo  $value['id']; ?>" >
                        ...
                        <td><?php if(!empty($value['name'])){echo $name->english;}?></td>
                         <?php 
