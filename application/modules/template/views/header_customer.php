        ...
        <ul class="side-items">
            ...
            <li>
                <a href="<?php echo 'mailto:'.$contact_us_info['email'];?>" class="bord-botm">
                   ...
                   <p><?php echo $contact_us_info['email']; ?></p>
                </a>
            </li>
        </ul>
        <div class="account-links">
    ...
    <header>
        ...
        <div class="container">
            <div class="inner">
                ...
                <form method="GET" action="<?= base_url('search'); ?>" class="search-box">
                ...
                <?php if($active_auction_categories_header):
                 ...
                 ?>
                    <?php foreach ($active_auction_categories_header as $key => $value):
                        ...
                        ?>
                            <li class="<?= (isset($headerCategoryId) && !empty($headerCategoryId)) ? (($value['id'] == $headerCategoryId) ? 'active' : '') : (($j == 1) ? 'active' : '') ;?>">
                                <!-- <?php //if (!empty($value['item_count'])) { ?> -->
                                    <a href="<?= base_url('search/').$value['id']; ?>"><?= $title->$language; ?></a>
                                <!-- <?php //}else{ ?>
                                    <?= $title->$language; ?>
                                <?php //} ?> -->
                            </li>
                      ...
                      <div class="content for-login">
                          ...
                          <form action="post">
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" />
                              ...
                              <div class="form-group">
                                  <label><?= $this->lang->line('enter_password'); ?><span>*</span></label>
                                  <input type="password"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
          <div class="modal-body">
                          ...
                          <form>
                            <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
                              <div class="form-group">
                                  ...
                                  <input type="text" oninput="this.value=this.value.replace(/[^aA-zZ0-9\s]/g,'');" placeholder="Enter name" class="form-control" name="username">
                              ...
                              <div class="form-group">
                                  <label><?= $this->lang->line('create_password'); ?><span>*</span></label>
                                  <input type="password"
                              ...
                              <div class="button-row">
                                  <button type="button" id="register-verify" class="btn btn-primary w-100" disabled="disabled"><?= $this->lang->line('sign_up'); ?></button>
                              </div>
                          </form>
                          <div class="signup-link">
           ...
           <p class="terms-condition">
			   <?= $this->lang->line('sign_up_agree'); ?> <?= $this->lang->line('sign_up_agree');?>
                <a
                href="<?php echo base_url('terms-conditions');?>"ndata-toggle="modal" data-target="#termsModal"><?= $this->lang->line('terms_and_conditions'); ?><?= $this->lang->line('terms_and_conditions');?>.</a>
            </p>
      </div>
    </div>
</div>
