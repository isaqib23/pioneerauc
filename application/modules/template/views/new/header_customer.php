...
?>
<style>
	.rtl .mobile-menu sidenav .account-links .lang-dropdown {
...
<div class="modal fade login-modal" id="registerModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <p class="terms-condition">
                <?= $this->lang->line('sign_up_agree');?>
                <a href="<?php echo base_url('terms-conditions');?>"ndata-toggle="modal" data-target="#termsModal"><?= $this->lang->line('terms_and_conditions'); ?>.</a>
            </p>
        </div>
    </div>
</div>
