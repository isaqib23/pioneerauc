...
<html lang="en">
  <head>
    ...
    <link href="<?php echo base_url();?>new/assets/images/favicon.png" rel="shortcut icon" type="image/x-icon" />
...
<!--   <link rel="stylesheet" href="<?php echo base_url();?>assets_user/css/slick.css">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="margin-top: 10px; margin-bottom: 20px !important;">
              ...
              <!-- <a class="site_title"><img class="center" width="45%" src="<?php echo base_url();?>upload/logo2.png"></a> -->
            </div>
			...
			<?php  $this->load->view('template/template_sidebar');?>
