...
<div class="main-wrapper vehicles">
    <div class="container">
        ...
        <div class="description-listing">
            <h1 class="page-title"><?php $item_name = json_decode($item['item_name']); echo strtoupper($item_name->$language);?></h1>
            <ul class="item-stats d-flex align-items-center">
                ...
                <li> 
                    ...
                    if($language == 'arabic'){
                        ...
                        echo datefmt_format( $fmt , $bid_end_time);
                    }else{
                        echo date('D, M d, Y' ,$bid_end_time) ?> - <?= date('h:i A' ,$bid_end_time); 
                    }
                    ?>
                </li>
            </ul>
                            ...
                            <div class="slider-for">
                                ...
                                if ($images):
                                    foreach ($images as $key => $value): ?>
                                        <div class="img">
                                            <img onclick="sliderRefresh()" data-toggle="modal" data-target="#imgModal" src="<?= base_url('uploads/items_documents/').$item['id'].'/'.$value['name']; ?>">
                                        </div>
                                    <?php endforeach; 
                                else: ?>
                                    <img data-toggle="modal" onclick="sliderRefresh()" data-target="#imgModal" src="<?= base_url('assets_admin/images/product-default.jpg'); ?>" alt="">
                                <?php endif; ?>
                            </div>
                            <img class="full-screen" data-toggle="modal" onclick="sliderRefresh()" data-target="#imgModal" width="40" src="<?= NEW_ASSETS_USER; ?>/new/images/full-screen-selector.svg">
                        </div>
                            ...
                            <ul class="d-flex justify-content-between align-items-center">
                                <li>
                                    ...
                                    if($language == 'arabic'){
                                        ...
                                        echo date('jS M Y', $bid_end_time); 
                                    }
                                  //echo date('jS M Y',  strtotime($item['bid_end_time']));

                                    $endObj = new DateTime(date('Y-m-d H:i:s', $bid_end_time));
                                    $now = new DateTime();
                                    ...
                                    <div class="your-bid bid-div<?= $item['item_id']; ?>" id="hidebid_section">
                                        ...
                                        <div class="form-group bid-items">
                                            ...
                                            if($balance > 0):
                                                ...
                                                <p class="paddinflft0" data-increment="<?php echo $minBid;?>" data-max="<?= $nBalance; ?>" data-price="<?php echo ((float)$crrnt+(float)$minBid);?>">
                                                    ...
                                                    <span class="inputlabelcurr">
                                                        ...
                                                        <input  type="number" min="<?php echo ((float)$crrnt+(float)$minBid);?>" step="<?php echo $minBid;?>" id="bid_amount" name="bid_amount" placeholder="<?= $this->lang->line('place_direct_offer');?>" class="total bid_amount_" value="<?php echo ((float)$crrnt+(float)$minBid);?>" >
                                                    </span>
                                            ...
                                            <button 
                                                ...
                                                data-max-bid="<?= (float)$balance*10; ?>" id="bid_btn" class="btn btn-primary smplce"><?= $this->lang->line('place_bid');?>
                                            </button>
                                        </div>
                                        <!-- <p>
                                        ...
                                        <!-- <div class="form-group bid-items">
                                            <ul class="aed-buttons">
                                                <li>
                                                    ...
                                                    <button type="button" class="btn-counter bidder-button" onclick="bidButtons(this)" value="100">AED 100</button>
                                                </li>
                                                <li>
                                                    
                                                    <button type="button" class="btn-counter bidder-button" onclick="bidButtons(this)" value="500">AED 500</button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn-counter bidder-button" onclick="bidButtons(this)" value="1000">AED 1000</button>
                                                </li>
                                                <li>
                                                    <button type="button" class="btn-counter bidder-button" onclick="bidButtons(this)" value="2000">AED 2000</button>
                                                </li>
                                            </ul>
                                        </div> -->
                                ...
                                <?php if ($balance == 0): ?>
                                   <!--  <ul class="h-list deposit-links">
                                        ...
                                        <li>
                                            ...
                                            ?>
                                            <a href="<?//= base_url('/customer/deposit?'); ?>" class="btn btn-default sm" ><?//= $this->lang->line('pay_deposit');?></a>
                                ...
                                <div class="button-row report-btn">
                                    <ul>
                                        <?php if (($category['include_make_model'] == 'yes') && ($item['inspected']=='yes')) : ?>
                                            <li>
                                                <a href="<?= base_url('inspection_report/').$item['id']; ?>" class="btn-primary" target="_blank"><?= $this->lang->line('cond_report');?></a>
                                            </li>
                                        <?php endif; ?>
                                        <?php $f = 0;
                                ...
                                <div class="col-xl-12">
                                    <div class="product">
                                        <div class="body">
                                            ...
                                            <a href="<?= $url; ?>">
                                                <?php if ($rel_images) { ?>
                                                    <div class="image background-cover" style="background-image: url(<?= base_url('uploads/items_documents/').$related_item['item_id'].'/'.$rel_images['name']; ?>);" >
                                                        <span class="tag">
                    ...
                    <div class="slider-for-img">
                        ...
                        if ($images):
                            foreach ($images as $key => $img_value): ?>
                                <div class="img">
                                    <img src="<?= base_url('uploads/items_documents/').$item['id'].'/'.$img_value['name']; ?>">
                                </div>
                            <?php endforeach; 
                        else: ?>
        ...
        if (bid_amount < minimum_bid_price) {
            ...
            if (your_bid_amount > maximum_bid_amount) {
                ...
                $.ajax({
                    ...
                    data: {'item_id':itemID,'auction_id':auctionid,'seller_id':sellerid,'bid_amount':(bid_amount-current_price),'current_price':current_price,'start_price':start_price, [token_name] : token_value},
    ...
    $(document).ready(function(){
        window.setTimeout(function() {
            window.__sharethis__.load('inline-share-buttons', {
                ...
                spacing: 0,
                url: "<?php //echo base_url(); ?>", // custom url
                title: shareTitle,
...
var noofpaxinput = $('#bid_amount'), noofpaxinputInitVal = $(noofpaxinput).val(); 
