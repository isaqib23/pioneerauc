...
<body>
    ...
    <div class="uperdiv">
        <div class="main-container">
            ...
            <div class="lot">
            <h2>LOT:</h2>
            <h1><?php echo $auction_item_rows[$key]['order_lot_no']?></h1>
            </div>
            <div class="details">
                <ul class="div1">
            ...
            <div class="remarks">
                <h3><b>Remarks<b></h3>
                <h2><?php echo (isset($item_row[0]['detail']) && !empty($item_row[0]['detail'])) ?  json_decode($item_row[0]['detail'])->english  : 'N/A' ?></h2>
            </div>
