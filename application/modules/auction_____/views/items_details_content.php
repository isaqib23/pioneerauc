<?php $k=-1; foreach ($item_rows as $key => $item_row) { 
  $k++;
  // print_r($files_array[0][$k]['name']);die();
  // print_r($item_row);
  ?>
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="row">
                        ...
                        <p class="lead"><?php echo (isset($item_row[0]['name']) && !empty($item_row[0]['name'])) ? json_decode($item_row[0]['name'])->english : 'Product' ?></p>
                          <?php if(isset($files_array[0][$k]['name']) && !empty($files_array[0][$k]['name']))
                          {
                           ?>
                          <img style="max-width: 350px" class="img-responsive avatar-view" src="<?php echo base_url().'uploads/items_documents/'.$item_row[0]['id'].'/'.$files_array[0][$k]['name']; ?>" alt="Visa">
                        <?php }
                            else
                            { ?>
                          ...
                          <div class="table-responsive">
                            <table class="table">
                              <tbody>
                                ...
                                <?php endif; ?>
                                <?php if(!empty($item_row[0]['make_name'])) : ?>
                                  <tr>
                                ...
                                <?php endif; ?>
                                <?php if(!empty($item_row[0]['model_name'])) : ?>
                                 <tr>
                                ...
                                <?php 
                                 ...
                                 <!-- <tr>
                                  ...
                                  echo (isset($result_if_lot[0]['lot_no']) && !empty($result_if_lot[0]['lot_no'])) ? $result_if_lot[0]['lot_no'] : '';
                                     ?> 
                                   </td>
                                </tr> -->
                             <?php 

                              if(isset($item_row[0]['id']) && !empty($item_row[0]['id'])){
