    ...
    <div class="row main-content border-lite-grey">
      <div class="col-md-12">
        ...
        <div class="content email-content">
          ...
          <p class="bold message">Reset your password.<br>Please click the Link below to reset your Pioneer Auction Password.</p>

          <a href="{link_activation}" class="startup-btns btn">Reset Your Password</a>
          <br> 
          ...
          <p class=" small">Your login email: {email}</p>
