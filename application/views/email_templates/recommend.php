    ...
    <div class="row main-content border-lite-grey">
      <div class="col-md-12">
        ...
        <div class="content email-content">
          ...
          <p class="bold message">You are invited by {invitee} to create an account on qeopee.<br>Please click the button below to sign up.</p>

          <a href="{link_activation}" class="startup-btns btn">CREATE YOUR ACCOUNT</a>
          <br> 
